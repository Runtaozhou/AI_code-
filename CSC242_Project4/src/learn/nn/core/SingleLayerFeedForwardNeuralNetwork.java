...
abstract public class SingleLayerFeedForwardNeuralNetwork extends FeedForwardNeuralNetwork {
	...
	//	SingleLayerFeedForwardNeuralNetwork network1 = new SingleLayerFeedForwardNeuralNetwork( );
		
		
		
		/*
		String filename = args[0];
		int weightNum = numWeights("src/learn/lc/examples/" + filename);
		if(args[2].equals("decay")) {
			...
			List<Example> example = q.readfile("src/learn/lc/examples" + filename);
			...
			List<Example> example = p.readfile("src/learn/lc/examples" + filename);
