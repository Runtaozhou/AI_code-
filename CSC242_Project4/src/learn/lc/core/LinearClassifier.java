...
abstract public class LinearClassifier {
	...
	public void trainDecay(List<Example> examples, int nsteps, DecayingLearningRateSchedule schedule) {
		double[]acc=new double[nsteps];
		double[]se = new double[nsteps];
		Random random = new Random();
		int n = examples.size();
	...
	/**
	 * Train this LinearClassifier on the given Examples for the
	 * given number of steps, using decaying learning rate schedule.
	 */
	public void trainDecay(List<Example> examples, int nsteps) {
		trainDecay(examples, nsteps, new DecayingLearningRateSchedule() {
	...
	protected void trainingReportlo(List<Example> examples, int stepnum, int nsteps) {
